...
import Tharaabot.modules.sql.global_bans_sql as gban_sql
import Tharaabot.modules.sql.users_sql as user_sql
from Tharaabot import dispatcher, OWNER_ID, DEV_USERS
